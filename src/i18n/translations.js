export const translations = {
  es: {
    ...
    techstack: {
      ...
      data: 'Data & CMS',
      devops: 'DevOps & Infra',
      tech_React_desc: 'UIs reactivas y SPAs de alta interactividad',
      tech_NextJS_desc: 'SSR, SSG y rutas de API en producción',
      tech_InertiaJS_desc: 'Monolitos modernos con Laravel + React',
      tech_JavaScript_desc: 'Lógica de negocio, async/await, módulos',
      tech_HTML5_desc: 'Markup semántico, Web APIs nativas',
      tech_CSS3_desc: 'Layouts avanzados, animaciones, variables',
      tech_Bootstrap_desc: 'Sistemas de grid y UIs preparadas',
      tech_Java_desc: 'Aplicaciones robustas y orientadas a objetos',
      tech_PHP_desc: 'APIs REST y lógica de servidor eficiente',
      tech_SpringBoot_desc: 'Microservicios empresariales y APIs REST',
      tech_Laravel_desc: 'Backends MVC, autenticación, colas, ORM',
      tech_Symfony_desc: 'Arquitectura modular y componentes reutilizables',
      tech_SQL_desc: 'Consultas optimizadas, joins, índices, vistas',
      tech_MariaDB_desc: 'Gestión y administración concurrente',
      tech_PostgreSQL_desc: 'Modelado relacional y objetos orientados',
      tech_WordPress_desc: 'CMS con themes custom y desarrollo de plugins',
      tech_Ubuntu_desc: 'Administración de servidores Linux',
      tech_Docker_desc: 'Contenedores, compose y entornos reproducibles',
      tech_Portainer_desc: 'Gestor visual de stacks y contenedores',
      tech_Nginx_desc: 'Reverse proxy, gestión de certificados SSL/TLS',
      tech_Apache_desc: 'Configuración y hosting de servidores web',
      tech_AWS_desc: 'Infraestructura cloud, EC2, S3',
      tech_Cloudflare_desc: 'Gestión DNS, WAF y caché (CDN)',
      tech_Git_desc: 'Versionado de código y control de ramas',
      tech_GitHub_desc: 'Colaboración, code reviews y almacenamiento',
    },
    about: {
      label: '// about.me',
  ...
  en: {
    ...
    techstack: {
      ...
      data: 'Data & CMS',
      devops: 'DevOps & Infra',
      tech_React_desc: 'Reactive UIs and high-interactivity SPAs',
      tech_NextJS_desc: 'SSR, SSG and API routes in production',
      tech_InertiaJS_desc: 'Modern monoliths with Laravel + React',
      tech_JavaScript_desc: 'Business logic, async/await, modules',
      tech_HTML5_desc: 'Semantic markup, native Web APIs',
      tech_CSS3_desc: 'Advanced layouts, animations, variables',
      tech_Bootstrap_desc: 'Grid systems and ready-made UI components',
      tech_Java_desc: 'Robust, object-oriented applications',
      tech_PHP_desc: 'REST APIs and efficient server-side logic',
      tech_SpringBoot_desc: 'Enterprise microservices and REST APIs',
      tech_Laravel_desc: 'MVC backends, auth, queues, ORM',
      tech_Symfony_desc: 'Modular architecture and reusable components',
      tech_SQL_desc: 'Optimized queries, joins, indexes, views',
      tech_MariaDB_desc: 'Concurrent management and administration',
      tech_PostgreSQL_desc: 'Relational and object-oriented data modeling',
      tech_WordPress_desc: 'CMS with custom themes and plugin development',
      tech_Ubuntu_desc: 'Linux server administration',
      tech_Docker_desc: 'Containers, compose and reproducible environments',
      tech_Portainer_desc: 'Visual stack and container manager',
      tech_Nginx_desc: 'Reverse proxy, SSL/TLS certificate management',
      tech_Apache_desc: 'Web server configuration and hosting',
      tech_AWS_desc: 'Cloud infrastructure, EC2, S3',
      tech_Cloudflare_desc: 'DNS management, WAF and CDN caching',
      tech_Git_desc: 'Code versioning and branch management',
      tech_GitHub_desc: 'Collaboration, code reviews and storage',
    },
    about: {
      label: '// about.me',
  ...
  de: {
    ...
    techstack: {
      ...
      data: 'Data & CMS',
      devops: 'DevOps & Infra',
      tech_React_desc: 'Reaktive UIs und interaktive SPAs',
      tech_NextJS_desc: 'SSR, SSG und API-Routen in der Produktion',
      tech_InertiaJS_desc: 'Moderne Monolithen mit Laravel + React',
      tech_JavaScript_desc: 'Geschäftslogik, async/await, Module',
      tech_HTML5_desc: 'Semantisches Markup, native Web-APIs',
      tech_CSS3_desc: 'Erweiterte Layouts, Animationen, Variablen',
      tech_Bootstrap_desc: 'Grid-Systeme und fertige UI-Komponenten',
      tech_Java_desc: 'Robuste, objektorientierte Anwendungen',
      tech_PHP_desc: 'REST-APIs und effiziente serverseitige Logik',
      tech_SpringBoot_desc: 'Enterprise-Microservices und REST-APIs',
      tech_Laravel_desc: 'MVC-Backends, Auth, Queues, ORM',
      tech_Symfony_desc: 'Modulare Architektur und wiederverwendbare Komponenten',
      tech_SQL_desc: 'Optimierte Abfragen, Joins, Indizes, Views',
      tech_MariaDB_desc: 'Parallele Verwaltung und Administration',
      tech_PostgreSQL_desc: 'Relationale und objektorientierte Datenmodellierung',
      tech_WordPress_desc: 'CMS mit benutzerdefinierten Themes und Plugin-Entwicklung',
      tech_Ubuntu_desc: 'Linux-Serververwaltung',
      tech_Docker_desc: 'Container, Compose und reproduzierbare Umgebungen',
      tech_Portainer_desc: 'Visueller Stack- und Container-Manager',
      tech_Nginx_desc: 'Reverse Proxy, SSL/TLS-Zertifikatsverwaltung',
      tech_Apache_desc: 'Webserver-Konfiguration und Hosting',
      tech_AWS_desc: 'Cloud-Infrastruktur, EC2, S3',
      tech_Cloudflare_desc: 'DNS-Verwaltung, WAF und CDN-Caching',
      tech_Git_desc: 'Code-Versionierung und Branch-Verwaltung',
      tech_GitHub_desc: 'Zusammenarbeit, Code-Reviews und Speicherung',
    },
    about: {
      label: '// about.me',
